...
print('Agora digite a cada linha as cadeiras que você gostaria de se matricular e em qual turma, garanta que tenha vaga ainda, não tenha conflito entre elas e o numero mínimo de creditos. Siga o formato "CCCCCCC - TT", quando terminar digite "sair"')
...
print('Matrícula realizada, queira verificar por favor.\nUm oferecimento de PATATIRO e PATATRAFICO')
